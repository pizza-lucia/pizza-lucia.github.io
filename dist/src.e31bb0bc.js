...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"components/Toppings.svelte":[function(require,module,exports) {
"use strict";
...
/* components/Toppings.svelte generated by Svelte v3.12.1 */
const file = "components/Toppings.svelte";

function add_css() {
  var style = (0, _internal.element)("style");
  style.id = 'svelte-1jix284-style';
  style.textContent = ".tag.svelte-1jix284{margin:0 4px}\n";
...
function create_each_block(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      (0, _internal.attr_dev)(span, "class", "tag is-medium svelte-1jix284");
      (0, _internal.add_location)(span, file, 11, 2, 123);
    },
    ...
    p: function update(changed, ctx) {
      if (changed.toppings && t_value !== (t_value = ctx.topping + "")) {
        (0, _internal.set_data_dev)(t, t_value);
      }
    },
  ...
  (0, _internal.dispatch_dev)("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(11:0) {#each toppings as topping}",
    ctx
  });
  return block;
}
...
class Toppings extends _internal.SvelteComponentDev {
  constructor(options) {
    super(options);
    if (!document.getElementById("svelte-1jix284-style")) add_css();
    (0, _internal.init)(this, options, instance, create_fragment, _internal.safe_not_equal, ["toppings"]);
...
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/Pizza.svelte":[function(require,module,exports) {
"use strict";
...
/* components/Pizza.svelte generated by Svelte v3.12.1 */
const file = "components/Pizza.svelte"; // (23:8) {#if featured}
...
function create_if_block(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      (0, _internal.add_location)(span, file, 23, 10, 629);
    },
    m: function mount(target, anchor) {
      (0, _internal.insert_dev)(target, span, anchor);
    },
...
function create_fragment(ctx) {
  var li, div3, header, p, span0, t0, t1, span1, t2, t3, t4, div0, small, t5, t6, t7, span2, t8, t9, div2, div1, current;
  var if_block = ctx.featured && create_if_block(ctx);
  var toppings_1 = new _Toppings.default({
    props: {
  ...
  const block = {
    c: function create() {
      ...
      toppings_1.$$.fragment.c();
      (0, _internal.attr_dev)(span0, "class", "tag is-success");
      (0, _internal.set_style)(span0, "margin-right", "0.5rem");
      (0, _internal.add_location)(span0, file, 20, 8, 476);
      (0, _internal.attr_dev)(span1, "class", "is-size-5");
      (0, _internal.add_location)(span1, file, 21, 8, 558);
      (0, _internal.attr_dev)(p, "class", "card-header-title");
      (0, _internal.add_location)(p, file, 19, 6, 438);
      (0, _internal.set_style)(small, "margin-right", "1rem");
      (0, _internal.add_location)(small, file, 28, 8, 770);
      (0, _internal.attr_dev)(span2, "class", "tag is-medium is-warning");
      (0, _internal.add_location)(span2, file, 29, 8, 830);
      (0, _internal.attr_dev)(div0, "class", "card-header-icon");
      (0, _internal.add_location)(div0, file, 27, 6, 731);
      (0, _internal.attr_dev)(header, "class", "card-header");
      (0, _internal.add_location)(header, file, 18, 4, 403);
      (0, _internal.attr_dev)(div1, "class", "content");
      (0, _internal.add_location)(div1, file, 33, 6, 949);
      (0, _internal.attr_dev)(div2, "class", "card-content");
      (0, _internal.add_location)(div2, file, 32, 4, 916);
      (0, _internal.attr_dev)(div3, "class", "card");
      (0, _internal.add_location)(div3, file, 17, 2, 380);
      (0, _internal.attr_dev)(li, "class", "column is-half");
      (0, _internal.add_location)(li, file, 16, 0, 350);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
    m: function mount(target, anchor) {
      ...
      (0, _internal.append_dev)(li, div3);
      (0, _internal.append_dev)(div3, header);
      ...
      (0, _internal.append_dev)(span2, t8);
      (0, _internal.append_dev)(div3, t9);
    ...
    p: function update(changed, ctx) {
      if (!current || changed.number) {
        (0, _internal.set_data_dev)(t0, ctx.number);
      }

      if (!current || changed.name) {
        (0, _internal.set_data_dev)(t2, ctx.name);
      }
      ...
      if (!current || changed.weight) {
        (0, _internal.set_data_dev)(t5, ctx.weight);
      }

      if (!current || changed.amount) {
        (0, _internal.set_data_dev)(t8, ctx.amount);
      }

      var toppings_1_changes = {};
...
function instance($$self, $$props, $$invalidate) {
  ...
  const writable_props = ['name', 'weight', 'featured', 'price', 'currency', 'toppings', 'number'];
  Object.keys($$props).forEach(key => {
...
class Pizza extends _internal.SvelteComponentDev {
  constructor(options) {
    super(options);
    (0, _internal.init)(this, options, instance, create_fragment, _internal.safe_not_equal, ["name", "weight", "featured", "price", "currency", "toppings", "number"]);
    (0, _internal.dispatch_dev)("SvelteRegisterComponent", {
      component: this,
      tagName: "Pizza",
      options,
...
var _default = Pizza;
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","./Toppings.svelte":"components/Toppings.svelte"}],"pizzas.json":[function(require,module,exports) {
module.exports = [{
  "name": "Mateo",
  "price": 5.6,
  "toppings": ["par. omáčka", "syr", "šunka", "šampióny", "kukorica"],
  "weight": 780,
  "currency": "EUR",
  "featured": true
}, {
  ...
  "name": "Rusticana",
  "price": 5.6,
  "toppings": ["par. omáčka", "syr", "šunka", "olivy", "kukorica", "artičoky", "syr Cottage"],
  "weight": 850,
  "currency": "EUR",
  "featured": false
}, {
  ...
  "name": "Provinciale",
  "price": 5.6,
  "toppings": ["par. omáčka", "syr", "šunka", "slanina", "kukorica", "feferóny"],
  "weight": 750,
  "currency": "EUR",
  "featured": false
}, {
  ...
  "name": "Proscuitto crudo rucola",
  "price": 6.6,
  "toppings": ["par. omáčka", "syr", "mozzarella", "proscutto crudo", "ruccola", "paradajka"],
  "weight": 850,
  "currency": "EUR",
  "featured": false
}, {
  ...
  "name": "Hercules",
  "price": 5.6,
  "toppings": ["par. omáčka", "syr", "saláma", "paprika", "kukorica", "feferóny", "gorgonzola"],
  "weight": 800,
  "currency": "EUR",
  "featured": false
}, {
...
function get_each_context(ctx, list, i) {
  ...
  child_ctx.index = i;
  return child_ctx;
} // (8:4) {#each pizzas as pizza, index}


function create_each_block(ctx) {
  var current;
  var pizza_spread_levels = [ctx.pizza, {
    number: ctx.index + 1
  }];
  let pizza_props = {};

  for (var i = 0; i < pizza_spread_levels.length; i += 1) {
    pizza_props = (0, _internal.assign)(pizza_props, pizza_spread_levels[i]);
  }

  var pizza = new _Pizza.default({
    props: pizza_props,
    $$inline: true
  });
  const block = {
    ...
    m: function mount(target, anchor) {
      (0, _internal.mount_component)(pizza, target, anchor);
      current = true;
    },
    p: function update(changed, ctx) {
      var pizza_changes = changed.pizzas ? (0, _internal.get_spread_update)(pizza_spread_levels, [(0, _internal.get_spread_object)(ctx.pizza), pizza_spread_levels[1]]) : {};
    ...
    d: function destroy(detaching) {
      (0, _internal.destroy_component)(pizza, detaching);
    }
  };
  (0, _internal.dispatch_dev)("SvelteRegisterBlock", {
    block,
    id: create_each_block.name,
    type: "each",
    source: "(8:4) {#each pizzas as pizza, index}",
    ctx
  });
  return block;
}
...
function create_fragment(ctx) {
  var div, ul, current;
  let each_value = _pizzas.default;
  let each_blocks = [];
  ...
  const block = {
    c: function create() {
      ...
      (0, _internal.add_location)(ul, file, 6, 2, 122);
      (0, _internal.attr_dev)(div, "class", "container");
      (0, _internal.add_location)(div, file, 5, 0, 96);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
var _default = App;
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","./Pizza.svelte":"components/Pizza.svelte","../pizzas.json":"pizzas.json"}],"index.js":[function(require,module,exports) {
"use strict";
